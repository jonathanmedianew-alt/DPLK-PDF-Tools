...
export default function LoadingOverlay({
  ...
  return (
    <motion.div
      ...
      className={`flex flex-col items-center justify-center bg-gray-50/98 backdrop-blur-xs z-50 ${
      ...
      <div className="flex flex-col items-center text-center max-w-sm px-6">
        ...
        <div className="relative mb-6 flex items-center justify-center">
          ...
          <motion.div
            ...
            className="absolute w-24 h-24 rounded-full border-2 border-dashed border-rose-300/60"
          />
        ...
        >
          <div className="flex items-center justify-center gap-1.5">
            <span className="font-mono text-[10px] tracking-wider uppercase text-rose-600 bg-rose-50 border border-rose-100 rounded-full px-2.5 py-0.5 font-bold flex items-center gap-1">
              <ShieldCheck className="h-3 w-3 text-rose-600" />
              <span>DPLK Engine</span>
            </span>
          </div>

          <h2 className="text-xl font-bold font-sans text-gray-900 tracking-tight leading-tight">
            {message}
          </h2>

          <p className="text-gray-400 text-xs font-sans max-w-xs leading-relaxed">
            {submessage}
          </p>
        </motion.div>

        {/* Modern Accent Progress Bar */}
        <div className="w-40 h-1 bg-gray-200/80 rounded-full overflow-hidden mt-6 relative">
          <motion.div
            initial={{ left: "-40%" }}
            animate={{ left: "100%" }}
            transition={{
